...
let x = 1
 ...
 // 6. Компьютер загадывает число от 1 до 50, а пользователь пытается угадать его.
...
// 7. Напишите программу, которая запрашивает у пользователя числа через prompt до тех пор, пока он не введёт 0. 
